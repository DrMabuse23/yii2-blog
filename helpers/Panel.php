...
namespace drmabuse\blog\helpers;
use yii\base\Object;
use yii\base\Widget;
 ...
 *      'panel' => [
 *          'htmlOptions' => [],
 *          'panelType'   => \common\helpers\Panel::PANEL_INFO,//primary success info warning danger
 *      ],
 *      'panelHeading' => [
 *          'title'         => $image->title,
 *          'htmlOptions'   => [],
 ...
 *              'buttons' => [
 *                  'label' => \common\helpers\Glyph::icon(\common\helpers\Glyph::ICON_ADJUST)
 *              ]
 *          ])
 *      ]
 * ]) ?>
