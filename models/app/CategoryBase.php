 ...
 * @property Post[] $posts
 */
class CategoryBase extends \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(PostLookupCategory::className(), ['category_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Post::className(), ['id' => 'post_id'])->viaTable('blog_post_lookup_category', ['category_id' => 'id']);
    }
}
