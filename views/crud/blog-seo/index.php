...
* @var common\models\app\BlogSeoSearch $searchModel
*/

$this->title = 'Blog Seos';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="blog-seo-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Blog Seo', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
