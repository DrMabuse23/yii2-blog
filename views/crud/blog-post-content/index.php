...
* @var drmabuse\blog\models\app\BlogPostContentSearch $searchModel
*/

$this->title = 'Blog Post Contents';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="blog-post-content-index">
    ...
    <div class="clearfix">
        <p class="pull-left">
            <?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Blog Post Content', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
